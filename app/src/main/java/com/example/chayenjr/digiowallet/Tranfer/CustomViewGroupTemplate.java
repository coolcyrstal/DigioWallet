 ...
 */
public class CustomViewGroupTemplate extends BaseCustomViewGroup implements Checkable{
    ...
    private void initInflate() {
        inflate(getContext(), R.layout.coustom_radio, this);
    }
    ...
    public void setRadioText(String s){
