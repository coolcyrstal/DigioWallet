...
public class PinConfirmAddBank extends Fragment {

    public interface pinCodeListener {
        void pinCodeSuccessBankAcc();
    }

    public PinConfirmAddBank() {
        // Required empty public constructor
    }

    public static PinConfirmAddBank newInstance() {
        PinConfirmAddBank fragment = new PinConfirmAddBank();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootview = inflater.inflate(R.layout.fragment_pin_confirm_add_bank, container, false);
        final PasscodeView passcodeView = (PasscodeView)rootview.findViewById(R.id.passcode_view_confirm_addBankAcc);
    ...
    private void goSuccess(){
        ...
        listener.pinCodeSuccessBankAcc();
